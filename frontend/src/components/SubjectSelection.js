...
const SubjectSelection = ({ onSelectionComplete }) => {
  ...
  // Models state is no longer needed here
  const [selectedCategory, setSelectedCategory] = useState('');
  const [customTopic, setCustomTopic] = useState('');
  // selectedModel state is no longer needed here
  ...
  useEffect(() => {
    fetchCategories();
    // fetchModels is no longer needed here
  }, []);
  ...
  // fetchModels function is removed
  ...
  const handleStartQuiz = () => {
    ...
    const config = {
      ...
      // Model is no longer selected here; backend uses global config
    };
      ...
      <div className="subject-selection">
        ...
        {questionSource === 'database' ? (
          ...
          <div className="form-group">
            ...
            {/* Model selection dropdown is removed */}
          </div>
        )}
